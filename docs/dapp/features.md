...
title: dApp Features and Capabilities
description: Overview of live features in the Subscrypts dApp, including subscription creation, payments, swaps, and Discord integration.
tags:
 - dapp
 - capabilities
 - subscriptions
...
For technical references, see the [Smart Contract Functions](smart-contract-functions.md) page.
...
For more about token operations and conversions, refer to the [Smart Contract Suite](../smart-contract/introduction.md) documentation.
...
!!! info "Planned Feature"
    Advanced revenue tracking features -- such as **per-plan payment monitoring** and **exporting transaction records for accounting or analytics** -- are part of the planned roadmap.
...
To learn more about how on-chain events interact with Discord, see [Access Control & Outputs](access-control.md).

!!! info "Ecosystem Connection"
    The Discord Bot listens to on-chain subscription events to automate role management. See the [Discord Bot Overview](../discord-bot/introduction.md) and [Subscription Sync](../discord-bot/subscription-sync.md) for details.
...
- **[dApp Subscriber Guide](subscriber-guide.md)** -- How these capabilities come together in a real-world subscription flow.
- **[dApp Merchant Guide](merchant-guide.md)** -- Plan creation, subscriber management, and revenue tracking for merchants.
- **[Smart Contract Functions in the dApp](smart-contract-functions.md)** -- Mapping UI actions to underlying on-chain function calls.
- **[Smart Contract Suite Overview](../smart-contract/introduction.md)** -- The on-chain contracts powering the dApp.
- **[Subscrypts ABI Reference](../smart-contract/abi-reference.md)** -- Low-level ABI details for developers and integrators.
