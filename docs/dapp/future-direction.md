---
title: dApp Roadmap and Future Direction
description: Planned enhancements for the Subscrypts dApp, from dashboards and analytics to marketplace features and multi-chain support.
tags:
 - dapp
 - roadmap
 - future
...
[Wallet Connection](wallet-connection.md) and [User Experience](subscriber-guide.md).
...
> [Current Capabilities](features.md) and [User Experience](subscriber-guide.md) and will be surfaced via richer dashboards rather than new protocol logic.
...
> In the existing docs, advanced revenue analytics and exports are flagged as **planned roadmap** features (see [Merchant Features](merchant-guide.md)).
> The goal here is to implement those in a way that stays faithful to the open-data, on-chain-first model described in [Access Control & Outputs](access-control.md).
...
> All renewal logic remains fully on-chain and permissionless, triggered via `subscriptionCollect()`, `subscriptionCollectByAddress()`, `subscriptionCollectByPlan()`, and optional passive collection hooks, as described in [Smart Contract Functions](smart-contract-functions.md).
...
The [Interact Page](interact-page.md) already exposes full ABI-driven control. Planned improvements include:
...
Building on the event-driven architecture described in [Access Control & Outputs](access-control.md), the mid-term goal is to provide:
...
These features take the roadmap notes in [Current Capabilities](features.md) and [Merchant Features](merchant-guide.md) and turn them into concrete, navigable sections within the dApp.
...
[Smart Contract Suite -- Future Development](../smart-contract/future-development.md).
...
All of this is driven by the open events summarized in [Smart Contract Functions](smart-contract-functions.md) and [Access Control & Outputs](access-control.md).
...
While the current dApp already supports mobile Web3 browsers (see [Wallet Connection](wallet-connection.md)), the long-term vision includes:
...
* **Smart Contract Upgrades**
  New facets and logic (documented in [Smart Contract Suite -- Future Development](../smart-contract/future-development.md)) will be surfaced in a user-friendly way through the dApp and the Interact page.
...
!!! info "Ecosystem Connection"
    The dApp roadmap is closely tied to upcoming **Smart Contract Suite** upgrades and **Discord Bot** enhancements. See [Smart Contract Future Development](../smart-contract/future-development.md) and [Discord Bot Future Direction](../discord-bot/future-direction.md) for the parallel roadmaps.
...
- **[dApp Features and Capabilities](features.md)** -- What the dApp can do today.
- **[dApp Subscriber Guide](subscriber-guide.md)** -- The current subscriber experience that will be enhanced.
- **[dApp Merchant Guide](merchant-guide.md)** -- Current merchant features that will be expanded.
- **[Smart Contract Future Development](../smart-contract/future-development.md)** -- Parallel contract-level roadmap.
- **[Subscrypts Roadmap](../subscrypts/roadmap.md)** -- The broader project roadmap and milestones.
