---
title: dApp Merchant Guide
description: How merchants use the Subscrypts dApp to create subscription plans, view subscribers, manage payments, and integrate Discord.
tags:
 - dapp
 - merchants
 - subscriptions
...
For technical reference, see [Smart Contract Functions](smart-contract-functions.md).

!!! info
    Plan creation may require a small setup fee to prevent spam and cover network gas costs.
...
!!! info "Planned Feature"
    Advanced revenue tracking -- such as detailed views of **payments made**, **total SUBS earned**, and historical performance metrics -- is part of the planned roadmap.
...
| -------------- | ------ | ---------- | ----------- | ------------- | ------------- |
| 0x8Ed1...3fd27 | Active | Yes          | 300 SUBS    | 2025-11-01    | 2025-12-01    |
| 0x7c29...A21b  | Active | No          | 100 SUBS    | 2025-10-30    | 2025-11-30    |

!!! info "Planned Feature"
    Data export options -- such as **CSV or Excel downloads for analytics and accounting** -- are part of the planned roadmap and will be available in future versions of the merchant dashboard.
...
* **1%** is routed to the [Subscrypts Treasury](../smart-contract/introduction.md) as a protocol fee.
...
!!! info "Planned Feature"
    The **Analytics and Reporting** features are part of the planned roadmap.
...
Learn more in [Access Control & Outputs](access-control.md).

!!! info "Ecosystem Connection"
    The **Discord Bot** automates role-based access for subscription communities. See the [Discord Bot Admin Setup Guide](../discord-bot/admin-setup-guide.md) for configuration instructions, and [Subscription Sync](../discord-bot/subscription-sync.md) for how on-chain events drive role updates.
...
!!! info "Ecosystem Connection"
    The **Smart Contract Suite** enforces all payment and governance logic on-chain. See [Smart Contract Access Control](../smart-contract/access-control.md) and [Smart Contract Compliance](../smart-contract/compliance.md) for details on how security and compliance are implemented at the protocol level.
...
- **[dApp Subscriber Guide](subscriber-guide.md)** -- See the subscription flow from the subscriber's perspective.
- **[dApp Wallet Connection Guide](wallet-connection.md)** -- Supported wallets, Arbitrum configuration, and transaction security.
- **[Smart Contract Functions in the dApp](smart-contract-functions.md)** -- Detailed mapping of UI actions to contract calls.
- **[Access Control & Outputs](access-control.md)** -- How permissions and events work from a dApp perspective.
- **[Discord Bot Admin Setup Guide](../discord-bot/admin-setup-guide.md)** -- Configure the Discord Bot for your community.
