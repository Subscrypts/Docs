---
title: Discord Bot Admin Setup Guide
...
* At launch, creating a Subscrypts subscription plan costs roughly **0.0000032 ETH** (approximately **$0.01**) per plan. This is an **example value only** -- actual fees could vary over time.
...
4. **Use a centralized exchange (CEX):**
    ...
    !!! warning "CEX Withdrawal Checklist"
        Always double-check three things before withdrawing:
...
!!! info "Where the Bot Communicates"
...
!!! ecosystem "Subscrypts Ecosystem"
    For a deep-dive into plan creation and quoting, see the [Subscrypts dApp docs](../dapp/introduction.md) and [Smart Contract Suite docs](../smart-contract/introduction.md) in this site.
...
!!! info "Automatic Role Management"
...
!!! tip "Post-Change Verification"
    After any major permissions/role rework in your server, re-run **Self-Test** to confirm everything still passes.
...
!!! tip "Help Your Members"
    Pin clear instructions in your `connect` channel and consider enabling a link to your "Subscribe" channel in your announcements.
...
- [Member Guide](member-guide.md) -- See the member journey from wallet linking to premium access
- [Commands Reference](commands-reference.md) -- All `/subs-admin` and member commands
...
- [Subscrypts dApp](../dapp/introduction.md) -- The general-purpose web interface for advanced management
...
* **Internal:** [Member Guide](member-guide.md) -- [Commands Reference](commands-reference.md) -- [Subscription Synchronization](subscription-sync.md) -- [Security & Trust](security-and-trust.md)
