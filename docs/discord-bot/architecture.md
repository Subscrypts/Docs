---
title: Discord Bot Architecture & Integration
description: Technical overview of how the Subscrypts Discord Bot connects to the blockchain and Discord, including syncing flows and event handling.
tags:
 - subscrypts
 - discord
 - architecture
...
!!! success "Source of Truth"
    The blockchain -- and specifically the **FacetView read functions** -- remains authoritative at all times. Caches are **ephemeral hints** for performance and **never** override on-chain verification prior to any grant/revoke action.
...
!!! ecosystem "Subscrypts Ecosystem"
    The bot, the [Subscrypts dApp](../dapp/introduction.md), and the [Subscrypts SDK](../sdk/index.md) are all clients of the same [Smart Contract Suite](../smart-contract/introduction.md) on Arbitrum. Any plan created through one interface is usable by the others.
...
- [Admin Setup Guide](admin-setup-guide.md) -- Step-by-step configuration for Discord server owners
- [Member Guide](member-guide.md) -- The subscriber wallet-linking and access experience
- [Subscription Synchronization](subscription-sync.md) -- Deep dive into the reconciler and role engine
- [Security & Trust](security-and-trust.md) -- Privacy model, wallet linking security, and data minimization
- [Smart Contract Suite](../smart-contract/introduction.md) -- On-chain subscription logic and FacetView functions
