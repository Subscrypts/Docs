---
title: Discord Bot Best Practices
description: Recommendations and solutions for managing a Subscrypts-enabled Discord server, minimizing sync issues, and resolving problems.
tags:
 - subscrypts
 - discord
 - best practices
...
- [Subscription Synchronization](subscription-sync.md) -- How on-chain state becomes Discord roles
