---
title: Discord Bot Commands Reference
...
- [Subscription Synchronization](subscription-sync.md) -- How the background reconciler uses on-chain data to keep Discord roles in sync
