...
- [Architecture & Integration](architecture.md) -- How the bot connects to Discord and the blockchain
- [Admin Setup Guide](admin-setup-guide.md) -- Step-by-step configuration for server owners
