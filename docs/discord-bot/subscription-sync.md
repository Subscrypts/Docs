---
title: Discord Bot Subscription Synchronization
description: How the Subscrypts Discord Bot syncs blockchain subscription states with Discord role access in real time.
tags:
 - subscrypts
 - discord
 - synchronization
...
| **Bot DB** (`planMap`, `linkedAccount`, ...)   | Discord-side config: which wallet is linked to which user, which plan maps to which role, audit logs.   | Metadata       |
...
!!! ecosystem "Subscrypts Ecosystem"
    For a deeper look at the subscription lifecycle and auto-renew logic, see the [Smart Contract Suite](../smart-contract/introduction.md) documentation. The [Subscrypts SDK](../sdk/index.md) also provides programmatic access to subscription state.
...
- [Architecture & Integration](architecture.md) -- How all bot components fit together
- [Commands Reference](commands-reference.md) -- Full list of admin and member commands
- [Best Practices & Troubleshooting](best-practices.md) -- Operational tips and common issue resolution
