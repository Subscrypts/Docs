---
title: Subscrypts Access Control & Roles
...
- [Security & Auditing](security-auditing.md) — the broader security architecture built on top of these access controls
- [Architecture Overview](architecture.md) — how roles interact with the modular proxy system
- [Compliance & Transparency](compliance.md) — governance events and regulatory alignment
- [Events & Off-Chain Integrations](events-integrations.md) — service account events and monitoring
- [dApp Access Control](../dapp/access-control.md) — how the dApp enforces on-chain access rules
...
!!! ecosystem "Related Components"
    ...
    - [Discord Bot Admin Setup Guide](../discord-bot/admin-setup-guide.md)
