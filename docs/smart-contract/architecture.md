---
title: Subscrypts Modular UUPS Proxy Architecture
description: In-depth explanation of the Subscrypts Smart Contract Suite modular UUPS proxy system and its core layers.
tags:
  - subscrypts
  - smart-contracts
  - architecture
...
- [Design Philosophy](design.md) — the principles that shaped this architecture
- [Data Structures & Storage](data-structures.md) — how persistent state is organized across upgrades
- [Gas Optimization & Scalability](gas-optimization.md) — performance strategies built into the architecture
- [Deployment & Network Information](deployment.md) — where and how the contracts are deployed
- [Subscrypts Architecture Overview](../subscrypts/architecture.md) — the broader platform architecture beyond smart contracts
