---
title: Subscrypts Compliance & Transparency
description: Regulatory alignment, MiCAR compliance, transparency mechanisms, and on-chain accountability framework.
tags:
  - subscrypts
  - smart-contracts
  - compliance
...
- [Security & Auditing](security-auditing.md) — the security mechanisms that enforce compliance controls
- [Access Control & Roles](access-control.md) — freeze, halt, and sanction function permissions
- [Events & Off-Chain Integrations](events-integrations.md) — governance events used for audit trails
- [Future Development & Upgrades](future-development.md) — evolving compliance modules on the roadmap
- [Subscrypts Compliance](../subscrypts/compliance.md) — platform-wide regulatory strategy
...
!!! ecosystem "Related Components"
    ...
    - [Subscrypts Compliance](../subscrypts/compliance.md)
