---
title: Subscrypts Data Structures & Storage
description: Explanation of the Subscrypts storage architecture, persistent state management, and Solidity data structures.
tags:
  - subscrypts
  - smart-contracts
  - storage
...
const subscryptsAddress = "0xE2E5409C4B4Be5b67C69Cc2C6507B0598D069Eac";
...
- [Architecture Overview](architecture.md) — how storage fits into the modular UUPS proxy system
- [Core Logic & Subscription Lifecycle](core-logic.md) — the plan and subscription structs in action
- [Gas Optimization & Scalability](gas-optimization.md) — storage layout strategies for gas efficiency
- [Subscrypts ABI Reference](abi-reference.md) — the developer interface to query stored data
- [SDK Components Reference](../sdk/components-reference.md) — SDK tools for reading on-chain data

!!! ecosystem "Related Components"
    - [dApp Smart Contract Functions](../dapp/smart-contract-functions.md)
    - [SDK Hooks Reference](../sdk/hooks-reference.md)
