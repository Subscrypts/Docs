---
title: Smart Contract Design Philosophy
description: Core design principles and rationale behind the Subscrypts Smart Contract Suite architecture.
tags:
  - subscrypts
  - smart-contracts
  - architecture
...
- [Architecture Overview](architecture.md) — detailed breakdown of the modular UUPS proxy system
- [Security & Auditing](security-auditing.md) — how security principles translate into implementation
- [Access Control & Roles](access-control.md) — the modifier-based permission model explained
- [Compliance & Transparency](compliance.md) — MiCAR alignment and on-chain auditability
- [Subscrypts Vision](../subscrypts/vision.md) — the broader vision behind the protocol
