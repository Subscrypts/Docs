---
title: Subscrypts Events & Off-Chain Integrations
description: On-chain events emitted by Subscrypts and how they integrate with the dApp, Discord Bot, and third-party systems.
tags:
  - subscrypts
  - smart-contracts
  - events
...
- [Core Logic & Subscription Lifecycle](core-logic.md) — the on-chain actions that emit these events
- [Subscrypts ABI Reference](abi-reference.md) — full ABI including all event signatures
- [Data Structures & Storage](data-structures.md) — the on-chain state that view functions expose
- [Architecture Overview](architecture.md) — how the proxy routes events and view calls
- [Discord Bot Subscription Sync](../discord-bot/subscription-sync.md) — how the bot consumes these events

!!! ecosystem "Related Components"
    - [Subscrypts dApp Introduction](../dapp/introduction.md)
    - [Discord Bot Architecture](../discord-bot/architecture.md)
