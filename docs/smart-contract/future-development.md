---
title: Subscrypts Future Development & Upgrades
description: Planned upgrades, roadmap, and architectural evolution for the Subscrypts Smart Contract Suite.
tags:
  - subscrypts
  - smart-contracts
  - roadmap
...
- [Architecture Overview](architecture.md) — the modular UUPS system enabling safe upgrades
- [Design Philosophy](design.md) — the principles guiding future development decisions
- [Compliance & Transparency](compliance.md) — how compliance evolves alongside the protocol
- [Subscrypts Roadmap](../subscrypts/roadmap.md) — the broader platform roadmap beyond smart contracts
- [Token Integration — SUBS Token](token-integration.md) — future staking and incentive mechanisms

!!! ecosystem "Related Components"
    - [dApp Future Direction](../dapp/future-direction.md)
    - [Discord Bot Future Direction](../discord-bot/future-direction.md)
    - [Subscrypts Roadmap](../subscrypts/roadmap.md)
