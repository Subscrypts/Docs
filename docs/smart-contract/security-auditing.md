---
title: Subscrypts Security & Auditing
description: Overview of the Subscrypts Smart Contract Suite security architecture, protection mechanisms, and audit readiness.
tags:
  - subscrypts
  - smart-contracts
  - security
...
* Publicly available ABI references at [ABI Reference](abi-reference.md).
...
- [Access Control & Roles](access-control.md) — the modifier-based permission model in detail
- [Compliance & Transparency](compliance.md) — MiCAR alignment and sanctions enforcement
- [Architecture Overview](architecture.md) — how security layers map to the proxy architecture
- [Design Philosophy](design.md) — the security-first principles that guided development
- [Subscrypts Compliance](../subscrypts/compliance.md) — platform-wide compliance strategy

!!! ecosystem "Related Components"
    - [Discord Bot Security & Trust](../discord-bot/security-and-trust.md)
    - [dApp Access Control](../dapp/access-control.md)
    - [Discord Bot Best Practices](../discord-bot/best-practices.md)
