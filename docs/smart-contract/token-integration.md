---
title: Subscrypts SUBS Token Integration
description: The SUBS ERC-20 utility token, its role in settlement, Uniswap integration, and governance readiness.
tags:
  - subscrypts
  - smart-contracts
  - subs-token
...
const subsTokenAddress = "0xE2E5409C4B4Be5b67C69Cc2C6507B0598D069Eac"; // SUBS ERC-20 contract
const privateKey = process.env.PRIVATE_KEY; // load from env/secret manager
...
async function main() {
  ...
  const paymentContractAddress = "0xE2E5409C4B4Be5b67C69Cc2C6507B0598D069Eac";
...
- [Payment & Conversion Mechanics](payment-conversion.md) — detailed payment flows and Uniswap swap logic
- [Core Logic & Subscription Lifecycle](core-logic.md) — how SUBS settlement fits into the subscription lifecycle
- [Compliance & Transparency](compliance.md) — MiCAR utility token classification and regulatory alignment
- [Subscrypts Tokenomics](../subscrypts/tokenomics.md) — supply, distribution, and long-term token strategy
- [Subscrypts Public Sale](../subscrypts/public-sale.md) — how to acquire SUBS tokens

!!! ecosystem "Related Components"
    - [dApp Wallet Connection](../dapp/wallet-connection.md)
    - [dApp Interact Page](../dapp/interact-page.md)
    - [SDK Wallet Connectors](../sdk/wallet-connectors.md)
