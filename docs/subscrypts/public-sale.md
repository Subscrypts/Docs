---
title: SUBS Public Sale (IDO)
description: Transparent breakdown of the SUBS token sale, allocations, circulation schedule, and rationale for the public IDO model.
tags:
  - subscrypts
  - token sale
  - IDO
...
**Total Circulating Supply at TGE:** **15.0 million SUBS** (**12.5%** of total supply)
...
**Total After Year 1:** ~**54.0 million SUBS** (~**45%** of total supply)
...
- [SUBS Tokenomics](tokenomics.md) — Full token supply, distribution, and utility model
- [Subscrypts MiCAR Compliance](compliance.md) — Regulatory framework and risk disclosures
- [How Subscrypts Works](solution.md) — How SUBS powers subscription payments
- [Subscrypts Roadmap](roadmap.md) — Post-launch development milestones
- [SUBS Token Integration](../smart-contract/token-integration.md) — Technical details of the ERC-20 contract
