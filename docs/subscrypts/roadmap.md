---
title: Subscrypts Roadmap
description: Subscrypts project roadmap with milestones, growth phases, planned technical enhancements, and long-term vision.
tags:
  - subscrypts
  - roadmap
  - development
...
* The contract deducts 30x the subscription amount from that single subscription for each billing period.
...
* The contract would perform an on-chain USDC to SUBS conversion and complete the renewal in a single flow.
...
!!! ecosystem "Related Components"
    - [Smart Contract Future Development](../smart-contract/future-development.md) — Planned smart contract upgrades and modularity improvements
    - [dApp Future Direction](../dapp/future-direction.md) — Upcoming dApp features and UX enhancements
    - [Discord Bot Future Direction](../discord-bot/future-direction.md) — Planned bot capabilities and integrations
...
- [Subscrypts Vision and Philosophy](vision.md) — Long-term goals driving the roadmap
- [SUBS Tokenomics](tokenomics.md) — Token distribution and vesting timelines
- [Subscrypts MiCAR Compliance](compliance.md) — Regulatory framework guiding feature development
- [Subscrypts Use Cases](use-cases.md) — Real-world applications these features will enable
- [Smart Contract Future Development](../smart-contract/future-development.md) — Technical roadmap for on-chain upgrades
