---
title: How Subscrypts Works
description: How Subscrypts uses smart contracts to power automated, transparent, and user-controlled subscription payments in Web3.
tags:
  - subscrypts
  - solution
  - smart-contracts
...
!!! ecosystem "Related Components"
    - [Smart Contract Core Logic](../smart-contract/core-logic.md) — Detailed contract mechanics for subscriptions
    - [Payment & Conversion Logic](../smart-contract/payment-conversion.md) — Fiat-denominated pricing and on-chain conversion
    - [dApp Subscriber Guide](../dapp/subscriber-guide.md) — How subscribers interact with the platform
    - [dApp Merchant Guide](../dapp/merchant-guide.md) — How merchants create and manage plans

---

## Related Topics

- [Subscrypts Architecture Overview](architecture.md) — System design and component interactions
- [Subscrypts Use Cases](use-cases.md) — Practical applications across industries
- [SUBS Tokenomics](tokenomics.md) — Token supply, utility, and economic model
- [Smart Contract Events & Integrations](../smart-contract/events-integrations.md) — On-chain events for developers
- [Getting Started for Developers](../getting-started/for-developers.md) — Developer integration quickstart
