---
title: Subscrypts Use Cases
description: Real-world use cases showing how Subscrypts supports SaaS, media, IoT, gaming, and online communities with decentralized subscriptions.
tags:
  - subscrypts
  - use cases
  - subscription
...
!!! info "Planned Feature"
    Volume licenses via multi-user plans are on the roadmap.
...
!!! ecosystem "Related Components"
    - [Smart Contract Events & Integrations](../smart-contract/events-integrations.md) — On-chain events for automating access control
    - [Discord Bot Use Cases](../discord-bot/solution-and-usecases.md) — Community subscription management via Discord
    - [dApp Merchant Guide](../dapp/merchant-guide.md) — Setting up subscription plans in the dApp
    - [Getting Started for Developers](../getting-started/for-developers.md) — Integration quickstart guide

---

## Related Topics

- [How Subscrypts Works](solution.md) — Technical details of the subscription payment flow
- [Subscrypts Architecture Overview](architecture.md) — System components and design
- [Subscrypts Roadmap](roadmap.md) — Upcoming features like volume licensing and USDC fallback
- [Smart Contract Core Logic](../smart-contract/core-logic.md) — On-chain subscription contract mechanics
- [Getting Started for Merchants](../getting-started/for-merchants.md) — Merchant onboarding guide
